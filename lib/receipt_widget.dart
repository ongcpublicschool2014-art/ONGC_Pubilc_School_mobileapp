...
class ReceiptWidget extends StatelessWidget {
  ...
  static const _serifFontFamily = 'Georgia';
                ...
                if (chunk.isLast) ...[
                  ...
                  Center(
                    child: Text(
                      ...
                      style: TextStyle(fontFamily: _serifFontFamily, fontSize: 14, color: _textDark),
                    ),
                  ),
                  ...
                  if (data.schoolEmail != null || data.schoolMobile != null)
                    Center(
                      child: RichText(
                        ...
                        text: TextSpan(
                          style: TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w500, color: _textMedium, height: 1.6),
                          children: [
                            const TextSpan(text: 'For any further inquiries, please contact us at '),
                            if (data.schoolEmail != null)
                              TextSpan(text: data.schoolEmail!, style: TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w600, color: _textMedium)),
                            if (data.schoolEmail != null && data.schoolMobile != null)
                              const TextSpan(text: ' or\ncall '),
                            if (data.schoolEmail == null && data.schoolMobile != null)
                              const TextSpan(text: ''),
                            if (data.schoolMobile != null)
                              TextSpan(text: data.schoolMobile!, style: TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w600, color: _textMedium)),
                          ],
                        ),
                      ),
                    ),
                  ...
                  Center(
                    child: Text(
                      ...
                      style: TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w500, fontStyle: FontStyle.italic, color: _textMedium),
                    ),
                  ),
                  const SizedBox(height: 20),
                ],
                  ...
                  child: Transform.rotate(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontFamily: _fontFamily, fontSize: 22, fontWeight: FontWeight.w600, color: data.status == 'paid' ? _paidGreen : const Color(0xFFFF3B30)),
                      ),
                    ),
                  ),
                ),
          ...
          child: Row(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(data.schoolName, style: const TextStyle(fontFamily: _fontFamily, fontSize: 14, fontWeight: FontWeight.w700, color: _darkBlue)),
                  const SizedBox(height: 3),
                  Text(data.schoolAddress, maxLines: 2, style: const TextStyle(fontFamily: _fontFamily, fontSize: 9, fontWeight: FontWeight.w500, color: _textMedium)),
                ],
              ),
            ],
          ),
        ...
        Row(
          ...
          children: [
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Fee Receipt', style: TextStyle(fontFamily: _fontFamily, fontSize: 16, fontWeight: FontWeight.w600, color: _primaryBlue)),
  ...
  Widget _buildStudentInfo() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('To:', style: TextStyle(fontFamily: _fontFamily, fontSize: 12, fontWeight: FontWeight.w600, color: _textDark)),
        const SizedBox(height: 8),
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                _labelValue('Standard:', data.courseName),
                const SizedBox(height: 6),
  ...
  Widget _wrappedLabelValue(String label, String value) {
    return Row(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(label, style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w600, color: _textDark)),
        const SizedBox(width: 6),
        Expanded(child: Text(value, style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w500, color: _textMedium))),
      ],
    );
  }
  ...
  Widget _labelValue(String label, String value) {
    return Row(
      ...
      children: [
        Text(label, style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w600, color: _textDark)),
        const SizedBox(width: 6),
        Text(value, style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w500, color: _textMedium)),
      ],
    );
  }
                        ...
                        children: [
                          const Expanded(
                            child: Text('Sub Total', textAlign: TextAlign.right,
                              style: TextStyle(fontFamily: _fontFamily, fontSize: 14, fontWeight: FontWeight.w700, color: Colors.white)),
                          ),
                          SizedBox(
                            width: 119,
                            child: Text('\u20B9${_formatAmount(data.total)}', textAlign: TextAlign.right,
                              style: const TextStyle(fontFamily: _fontFamily, fontSize: 14, fontWeight: FontWeight.w700, color: Colors.white)),
                          ),
                        ],
                      ),
                    ),
  ...
  Widget _headerCell(String text, {double? width, bool flex = false}) {
    final child = Container(
      ...
      child: Text(text, style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w600, color: _primaryBlue)),
    );
                  ...
                  for (var fee in term.fees)
                    Padding(
                      ...
                      child: Text(fee.type, textAlign: TextAlign.center,
                        style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w500, color: _textDark)),
                    ),
                ],
              ),
            ),
  ...
  Widget _dataCell(String text, {double? width, bool alignTop = false}) {
    return SizedBox(
      ...
      child: Container(
        ...
        child: Text(text, style: const TextStyle(fontFamily: _fontFamily, fontSize: 10, fontWeight: FontWeight.w500, color: _textDark)),
      ),
    );
  }
